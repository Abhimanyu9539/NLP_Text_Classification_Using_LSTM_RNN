# Text Classification using pre-trained Word Vectors
This repository contains the code for text classification using recurrent neural networks and glove pre-trained vectors.
